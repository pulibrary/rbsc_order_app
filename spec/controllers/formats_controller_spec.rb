  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved format as @format" do
        post :create, {:format => invalid_attributes}, valid_session
        expect(assigns(:format)).to be_a_new(Format)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested format" do
        format = Format.create! valid_attributes
        put :update, {:id => format.to_param, :format => new_attributes}, valid_session
        format.reload
    ...
    context "with invalid params" do
      it "assigns the format as @format" do
        format = Format.create! valid_attributes
        put :update, {:id => format.to_param, :format => invalid_attributes}, valid_session
        expect(assigns(:format)).to eq(format)
      end
